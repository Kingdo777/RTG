...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ucg = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.ucg.setMinimumSize(QtCore.QSize(0, 40))
        self.ucg.setMaximumSize(QtCore.QSize(57, 16777215))
        self.ucg.setAlignment(QtCore.Qt.AlignCenter)
        self.ucg.setObjectName("ucg")
        self.horizontalLayout_4.addWidget(self.ucg)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ucg.setText(_translate("MainWindow", "10"))
        self.ucg.setPlaceholderText(_translate("MainWindow", "mg"))
